  ...
  <div class="_tedx_menu_container">
    ...
    <div class="_tedx_sub_links">
      ...
      <div>
        <h4>Follow</h4>
        <ul>
          <li><a href="https://instagram.com/tedxuniversitasbrawijaya" cursor-class="hover">Instagram</a></li>
          <li><a href="https://twitter.com/tedxbrawijaya" cursor-class="hover">Twitter</a></li>
          <li><a href="https://liff.line.me/1645278921-kWRPP32q?accountId=cgu9302m&openerPlatform=webview&openerKey=webview%3AunifiedSearch" cursor-class="hover">Line</a></li>
        </ul>
      </div>
      <div>
        <h4>Contact Us</h4>
        <ul>
          ...
          <li><a href="mailto:sponsorshiptedxub@gmail.com" cursor-class="hover">Media</a></li>
        </ul>
      </div>
